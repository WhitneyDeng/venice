 ...
 */
public class VeniceControllerRequestHandlerDependencies {
  ...
  private VeniceControllerRequestHandlerDependencies(Builder builder) {
  ...
  public static class Builder {
    ...
    public VeniceControllerRequestHandlerDependencies build() {
      verify();
      return new VeniceControllerRequestHandlerDependencies(this);
    }
  }
}
